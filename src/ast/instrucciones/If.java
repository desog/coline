...
public class If implements Ins {
    ...
    LinkedList<Nodo> listaelse;
    int linea;
    
    public If(Exp condicion, LinkedList<Nodo> listanodo,int linea) {
        this.condicion = condicion;
        this.listanodo = listanodo;
        this.linea = linea;
    }

    public If(Exp condicion, LinkedList<Nodo> listanodo, LinkedList<Nodo> listaelse,int linea) {
        this.condicion = condicion;
        this.listanodo = listanodo;
                    ...
                    for (Nodo n : listanodo) {
                        if (n instanceof Ins) {
                            ...
                            if(n instanceof Continue){
                                ...
                                evaluacion1junio.Evaluacion1Junio.errorsemantico.add("ERROR SEMANTICO, LA SENTENCIA CONTINUE SOLO PUEDE SER USADA EN CICLOS, Linea: "+ getLinea());
                            }
                            }
                            Ins inst = (Ins) n;
