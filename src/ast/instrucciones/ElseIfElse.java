 ...
 * @author Diego
 */
public class ElseIfElse implements Ins {
    ...
    public ElseIfElse(Exp condicion, LinkedList<Nodo> listanodo, LinkedList<Nodo> listaelseif, LinkedList<Nodo> listaelse, int linea) {
